...
function App() {
  ...
  const menuData = {
    burgers: [
      { id: 1, title: "The Classic", price: "R$ 39,90", desc: "Blend suculento de 180g, queijo cheddar derretido e nossa exclusiva maionese defumada no pão brioche macio.", image: "/photos/burger2.jpg", tag: "Campeão de Vendas" },
      { id: 2, title: "The Cheese One", price: "R$ 48,90", desc: "Blend suculento de 180g, dobro de queijo cheddar derretido, molho especial artesanal no pão brioche tostado.", image: "/photos/cheese.jpg", tag: "Muito Queijo" },
      { id: 3, title: "The Bacon One", price: "R$ 44,90", desc: "Blend suculento de 180g, fatias crocantes de bacon premium, cheddar derretido e maionese defumada.", image: "/photos/burger1.jpg", tag: "Crocante" },
      { id: 4, title: "The Double One", price: "R$ 53,90", desc: "Dois blends suculentos de 180g (total 360g de carne), queijo cheddar duplo e maionese artesanal da casa.", image: "/photos/burger1.jpg", tag: "Super Fome" },
      { id: 5, title: "The Chicken Crispy", price: "R$ 42,90", desc: "Filé de frango super empanado e crocante, cheddar cremoso, alface fresco e molho leve da casa.", image: "/photos/burger2.jpg", tag: "Novidade" }
    ],
    pizzas: [
      { id: 6, title: "Pizza Pequena (25cm)", price: "R$ 38,00", desc: "Tamanho perfeito para matar a sua fome individual. 4 fatias generosas com os sabores tradicionais ou doces.", image: "/photos/burger3.jpg", tag: "Individual" },
      { id: 7, title: "Pizza Média (30cm)", price: "R$ 55,00", desc: "Ideal para compartilhar em duas pessoas. 8 fatias com até 2 sabores de sua preferência.", image: "/photos/burger3.jpg", tag: "Mais Pedida" },
      { id: 8, title: "Pizza Grande (35cm)", price: "R$ 80,00", desc: "Perfeita para a família ou o grupo de boliche. 12 fatias gigantes com até 3 sabores diferentes.", image: "/photos/burger3.jpg", tag: "Tamanho Família" }
    ],
    entradas: [
    ...
    bebidas: [
      { id: 15, title: "Gin de Morango", price: "Consulte", desc: "Drink refrescante de gin artesanal premium, xarope de morangos selecionados, água tônica e especiarias.", image: "/photos/drink.jpg", tag: "Exclusivo" },
    ...
    <>
      ...
      <nav className="navbar">
        <div className="navbar-container">
          <a href="#" className="nav-logo">
            <img src="/photos/profile.jpg" alt="Other Bowling Bar Logo" />
      ...
      <header className="hero-section">
        <div 
          ...
          style={{ backgroundImage: `url('/photos/og_image.png')` }}
        ></div>
        ...
        <div className="hero-container">
          ...
          <div className="hero-visual">
            ...
            <div className="hero-image-wrapper">
              <img src="/photos/burger2.jpg" alt="Delicioso burger The Ones" />
            </div>
          </div>
        </div>
      </header>
      ...
      <section id="boliche" className="promo-section">
        <div className="promo-container">
          ...
          <div className="promo-image-wrapper">
            <img src="/photos/burger3.jpg" alt="Combo Especial de Pizza e Boliche" />
          </div>
        </div>
      </section>
